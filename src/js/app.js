  ...
  press: () => {
    if (state.selectingNeuron) {
      ...
      adjustments.setValue(
        ...
        n.afterHyperPolarizationPotential
      );
      adjustments.setValue("membraneTau", n.membraneTau);
      adjustments.setValue("dendriteWeight", n.dendriteWeight);
      adjustments.setValue(
        "spontaneousRestingFrequency",
        n.spontaneousRestingFrequency
      );
      adjustments.setValue(
        "spontaneousFrequencyScale",
        n.spontaneousFrequencyScale
      );
...
workspace.onMouseMove(mouse => {
  // Selecting neuron
  let hoverNeuron = network
    .getAll()
    .find(n => workspace.mouseOverNeuron(n.x, n.y));
